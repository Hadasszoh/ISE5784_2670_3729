...
/**
 * Test class to check all functions of the Vector class.
 * This class contains unit tests for the constructors and various methods of the Vector class.
 * 
...
class VectorTest {
    ...
    public void testConstructor() {
        // TC:01 Constructor test for the zero vector, expected to throw an exception
    ...
    @Test
    void length() {
        // TC01: Test the length of a vector in 3D space
    ...
    @Test
    void normalize() {
        // TC:01 Test the normalization of a vector in 3D space
